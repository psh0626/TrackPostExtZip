...
- 미확인 메시지 조회 및 알림
    - Popup UI에서 미확인 메시지를 한눈에 확인하고, 등기번호 복사·국가 복사·모두 열기 기능 제공

- 국내 접수 정보 조회
    - Popup UI에 등기번호 입력 시 국내 접수 정보를 조회하여 Sidepanel에 표시

- 상대국 조사 요청 지원
    - 필수 정보 자동 입력 및 SDR 환율 자동 계산 기능 제공

- GCSS, iCare 편의 기능
    - 각 웹사이트 등기번호 입력 탭에 자동 대문자 변환 등 다양한 편의 기능 제공
    - iCare: Personal remarks 기능 추가
    - GCSS SUM 페이지: 마지막 작성자 표시 기능 제공

- 설정 페이지 제공
    - 미확인 메시지, Personal remarks, 환율 등 관련 설정 관리 페이지 제공

- 외부 메일 편의 기능
    - 공직자통합메일 및 포사웹메일이 로그아웃되지 않도록 주기적 새로고침 수행
    - 미확인 이메일 수를 브라우저 제목에 표시
      <br /><br />
